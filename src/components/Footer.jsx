        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-12 border-t border-white/10 pt-16">
          ...
          <div className="col-span-1 lg:col-span-5 pr-0 lg:pr-12">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Magnetic>
                <a href="https://github.com/Amit-Kumar1997" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 hover:bg-[#333] transition-all flex items-center justify-center text-white">
