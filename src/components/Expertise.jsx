...
export default function Services() {
  const services = [
    { title: 'Patents', img: 'https://images.unsplash.com/photo-1589254065878-42c9da997008?auto=format&fit=crop&w=600&q=80', link: '/patents' },
    { title: 'Copyright', img: 'https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?auto=format&fit=crop&w=400&q=80', link: '/copyright' },
