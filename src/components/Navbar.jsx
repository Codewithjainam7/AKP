      ...
      >
        ...
        >
          ...
          <ul className="hidden md:flex items-center space-x-8 w-1/3 justify-start">
            <li><a href="#hero" className="text-white hover:text-primary-600 transition-colors">Home</a></li>
            <li><a href="#about" className="text-white hover:text-primary-600 transition-colors">About</a></li>
            <li><a href="#research" className="text-white hover:text-primary-600 transition-colors">Research</a></li>
          </ul>
          
          {/* Logo (Center) */}
          <div className="w-1/3 flex justify-center">
            <a href="#" className="flex items-center space-x-1 group whitespace-nowrap">
          ...
          <div className="w-1/3 flex justify-end">
            ...
            <ul className="hidden md:flex items-center space-x-8">
              <li><a href="#patents" className="text-white hover:text-primary-600 transition-colors">Patents</a></li>
              <li><a href="#experience" className="text-white hover:text-primary-600 transition-colors">Career</a></li>
              <li><a href="#contact" className="text-white hover:text-primary-600 transition-colors">Contact</a></li>
            </ul>
